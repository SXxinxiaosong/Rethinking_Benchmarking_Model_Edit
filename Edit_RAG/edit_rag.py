...
if __name__ == "__main__":
    ...
    if args.model_type == "llama2":
        model_name = "/fs-computility/ai-shen/songxin/models/Llama-2-7b-chat"  #
    elif args.model_type == "llama3":
        model_name = "/fs-computility/ai-shen/songxin/models/Llama-3.1-8B-Instruct"
    elif args.model_type == "llama3-distill":
        model_name = "/fs-computility/ai-shen/songxin/models/DeepSeek-R1-Distill-Llama-8B"
    elif args.model_type == "mistral":
        model_name = "/fs-computility/ai-shen/songxin/models/Mistral-7B-Instruct-v0.1"
    ...
    elif args.retriever_type=="contriever":
        retriever_path = "/home/xsong/contriever"
        retriever = AutoModel.from_pretrained(retriever_path).to(args.device)
        retriever_tok = AutoTokenizer.from_pretrained(retriever_path)
    elif args.retriever_type=="ance":
        retriever_path = "/home/xsong/ance"
    ...
    if args.data_type == "zsre":
        data_dir = "/fs-computility/ai-shen/songxin/EasyEdit/examples/dataset/zsre/ZsRE-test-all.json"
        memory = prepare_memory("/fs-computility/ai-shen/songxin/EasyEdit/examples/dataset/zsre/ZsRE-test-all-sentence.json", num=args.memorry_size, start_index=args.memory_start_index,end_index=args.memory_end_index)
    elif args.data_type == "counterfact":
        data_dir = "/fs-computility/ai-shen/songxin/EasyEdit/examples/dataset/wiki_counterfact/test_cf.json"
        memory = prepare_memory("/fs-computility/ai-shen/songxin/EasyEdit/examples/dataset/wiki_counterfact/wiki_counterfact-test-all-sentence.json", num=args.memorry_size, start_index=args.memory_start_index,end_index=args.memory_end_index)
