...
if __name__ == "__main__":
    ...
    if args.data_type == "zsre":
        ...
        memory = prepare_memory("ZsRE-test-all-sentence.json", num=args.memorry_size, start_index=args.memory_start_index,end_index=args.memory_end_index)
    elif args.data_type == "counterfact":
        data_dir = "test_cf.json"
        memory = prepare_memory("wiki_counterfact-test-all-sentence.json", num=args.memorry_size, start_index=args.memory_start_index,end_index=args.memory_end_index)
    elif args.data_type == "ELKEN":
        data_dir = "test_filtered.json"
        memory = prepare_memory("test_filtered_event.json", num=args.memorry_size, start_index=args.memory_start_index,end_index=args.memory_end_index)
